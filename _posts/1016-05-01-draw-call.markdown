...
<span class="important">インダイレクト用のバッファを作成するときは<span class="keyward">MiscFlags</span>に<span class="keyward">D3D11_RESOURCE_MISC_DRAWINDIRECT_ARGS</span>を指定してください。</span>
